...
//   // int cnt=0;
//   if(sx>ex||sy>ey+1||sx<0||sy<0)return ;
...
//   cin>>ex>>ey;
//   vector<vector<int>>board(ey+1+1,vector<int>(ex+1,0));
...
//    // cout<<"sx = "<<sx<<" & sy = "<<sy<<endl;
//    if(sx>ex||sy>ey+1||sx<0||sy<0){return 0;} //cout<<"Went outside the maze"<<endl;
...
//    length=max(ex,sx);
//    cout<<"Height = "<<height<<" length = "<<length<<endl;
//    vector<vector<int>> obs(height+1+1,vector<int>(length+1,-1));
//    cout<<"Bool matrix before intilizing obstacles is : "<<endl;
//    show_bool(length,height,obs,-1,-1);
//    // cout<<"Enter number of obstacles you have : ";
//    // cin>>nobs;
